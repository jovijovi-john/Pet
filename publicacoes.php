                    ...
                    ?>  
                        <div class="container">
                            <div class="publicacao">
                                <h2 class="titulo-publicacao"><?php print_r((utf8_encode(htmlspecialchars_decode($row['titulo']))));?></h2>
                                <p class="autores-publicaco"><span class="span-autores">Autores:</span><?php print_r((utf8_encode(htmlspecialchars_decode($row['autores']))));?></p>
                                <a target="_blank" class="link-publicaco" href="<?php print_r((utf8_encode(htmlspecialchars_decode($row['link_publicacao']))));?>">Resumo</a>
                                <br>
                            </div>
                        </div>
